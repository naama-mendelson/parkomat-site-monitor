...
//   • `set_by_name` — **מעדיף זהות מאומתת** על השם שנשלח. אסימון גובר
//     על הגוף; השם המוקלד משמש רק כשאין אסימון.
//   • **השם חובה** — שם ריק או בן תו אחד נדחה ב-check_violation. גם
//     בפתיחה וגם בביטול.
...
//
// ⚠️ `p_performed_by` **כן** נשלח — לצד הזהות ולא במקומה. ההערה כאן
// אמרה פעם את ההפך ("name אינו נשלח"), מהתקופה שבה השם היה אופציונלי
// והמסד גזר אותו לבדו. מי שהכניס אתר לתחזוקה חייב לציין שם, ולכן
// השדה חזר — והערה שסותרת את הקוד מטעה יותר מהיעדר הערה.
