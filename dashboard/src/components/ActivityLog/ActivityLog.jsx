  ...
  if (e.kind === "suppressedFault") {
    ...
    if (e.reason === "replay") {
      return {
        ...
        icon: "⚠",
        title: "תקלה שלא נרשמה בזמנה",
        details: (e.faultText && e.faultText !== "תקלה שאבדה בקליטה ושוחזרה"
          ? e.faultText + " · " : "") +
          "ההודעה מהבקר אבדה בקליטה ושוחזרה מהיומן",
        // ⚠️ עדיין אינה נספרת: הכנסתה להיסטוריה הייתה מחייבת לפצל
        // מקטעים סגורים, כלומר לשכתב היסטוריה.
