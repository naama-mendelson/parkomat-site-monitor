...
function SiteCard({ site, density = "normal", expanded, onToggle, onHover, onOpenDetail, style }) {
  ...
  const details = (
    <div className="card-details">
      ...
      {/* ============================================================
          ⚠️ "טיפול בתקלה" והגרף עברו לפירוט המלא — החלטת מוצר
          ============================================================
          כאן ישבו ממוצע זמן הטיפול וגרף מקל-לכל-תקלה. שניהם עונים על
          שאלת **ניתוח** — "כמה חמורות התקלות באתר הזה" — והכרטיס עונה
          על שאלת **סריקה**: מי דורש טיפול עכשיו.

          ⚠️ והמחיר היה גדול במיוחד כאן, כי הממוצע לבדו מטעה: 10% התקלות
          הארוכות הן 68% מזמן התקלה, ובמגדל 1 הממוצע הוא 47 דקות מול
          חציון של פחות מדקה. כלומר המספר **חייב** את הגרף לצדו — שני
          אלמנטים לשאלה שאיש אינו שואל בזמן סריקה, בכרטיס שכבר נאבק
          על מקום.

          המקום החדש: InsightsModal, מקטע "טיפול בתקלות". שם יש רוחב
          לגרף מלא (42px במקום 26) ולשלושת המספרים לצדו. */}
    </div>
  );
    ...
    return (
      ...
      >
        ...
        <div className="exp-metrics">
          ...
          {/* ⚠️ גם האריח "טיפול בתקלה" ירד מכאן, ולא רק מהכרטיס המצומצם:
              הכרטיס המורחב הוא עדיין **הכרטיס**, ולידו יושב כפתור "פתח
              פירוט מלא" — שזה בדיוק המקום שאליו הנתון עבר. השארה כאן
              הייתה מציגה אותו בשני מסכים ומחייבת לשמור שניהם מסונכרנים. */}
