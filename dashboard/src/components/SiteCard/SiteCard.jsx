            ...
            {systems.map((u) => {
              ...
              return (
                ...
                >
                  ...
                  {/* ============================================================
                      ⚠️ הרכב מוצג **רק כשהמערכת בפעולה**
                      ============================================================
                      רגיסטר הכרטיס בבקר מחזיק את הכרטיס האחרון ואינו
                      מתאפס בסוף המחזור. נצפה בפלורנטין: המערכת ב"המתנה"
                      והכרטיס עדיין 18 — שארית מהרכב הקודם, שנקראת על
                      המסך כאילו רכב נמצא שם עכשיו.

                      ⚠️ וזה בדיוק הכלל שכבר קיים בכרטיס עצמו — "הכיוון
                      והכרטיס מוצגים רק אם הפעולה באמת פתוחה" — ושלא
                      הוחל כאן. כלל שקיים במקום אחד ולא בשני הוא כלל
                      שיישבר שוב. */}
                  {u.car && u.state === "operating"
                    ? <span className="system-car">רכב {u.car}</span>
                    : null}
                </span>
              );
            })}
