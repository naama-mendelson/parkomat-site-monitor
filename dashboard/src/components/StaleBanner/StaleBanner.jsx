    ...
    <div className="stale-banner" role="alert">
      ...
      <div>
        ...
        {/* ============================================================
            ...
            ⚠️ והפעולה **אינה** במסך הזה. הדשבורד רץ ב-Cloudflare Pages
            וקורא מ-Supabase ישירות, ולכן הוא עובד מצוין בזמן שהקליטה מתה.
            אין כאן כפתור ללחוץ עליו, ולא צריך להיות — התיקון הוא במחשב
            אחר לגמרי, ובלי שנאמר איפה, אי אפשר לבצע אותו. */}
        <div className="stale-banner-do">
          מה לעשות: במחשב <strong>DELL008</strong> — לחיצה כפולה על{" "}
          <strong>„הפעל את Parkomat”</strong> בשולחן העבודה. הוא מרים את
          המערכת ומסביר מה קרה.
        </div>
      </div>
    </div>
  );
