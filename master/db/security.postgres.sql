...
--
-- ההיקוף הוא **קריאה בלבד ולכולם המאומתים**, בכוונה. אין היום משתמשים
-- כלל (התפקיד בדשבורד הוא useState בדפדפן), ולכן כל חלוקה לפי אתרים או
-- תפקידים כאן הייתה ניחוש שנועל את עצמו. app.current_role() קיים ומוכן
-- לכשתהיה החלטה; המדיניות תתהדק אז בקובץ הזה בלבד.
--
