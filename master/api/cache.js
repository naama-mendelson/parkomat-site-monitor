...
// ⚠️ **month ו-year חייבים להיות כאן.** /api/stats/system קורא אותם
// מה-query, ובלעדיהם בקשה למרץ ובקשה לאפריל מקבלות את **אותו מפתח** —
// כלומר מי ששאל על אפריל בתוך חלון ה-TTL קיבל את הנתונים של מרץ,
// בלי שום סימן שמשהו לא בסדר.
//
// ⚠️ פרמטר שמשפיע על התשובה ואינו במפתח אינו "אופטימיזציה" — הוא
// תשובה שגויה שנשמרת ומוגשת שוב.
const KEY_PARAMS = [
