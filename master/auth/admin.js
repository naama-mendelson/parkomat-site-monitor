 ...
 * תפקיד, כל בקר היה יכול ליצור לעצמו חשבון שני בתפקיד מנכ"ל ולעלות בדרגה
...
async function createUser(email) {
  ...
  if (!ok) {
    ...
    // זה חייב להישאר: הכלל חוסם גם הרשמה עצמית וגם התחברות עם Google, ושתיהן
    // אינן עוברות כאן בכלל. שכפול הבדיקה לכאן היה יוצר מקור אמת שני שיתיישן.
    //
