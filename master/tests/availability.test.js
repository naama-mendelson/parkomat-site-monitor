...
test("תחזוקה שהתחילה בדיוק כשתקלה נגמרה = טיפול בתקלה", () => {
  const u = uptimeOf([
...
// פירושו שמישהו נסע לאתר — עלות אמיתית שחוזרת — והתאוששות עצמית היא לרוב
// ריצוד שהמכונה ניקתה לבד. אתר עם 5 השבתות שכולן נפתרו לבד הוא סיפור אחר
// מאתר עם 5 שכולן דרשו נסיעה.
//
